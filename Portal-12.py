                            ...
                            with open(nameas, "ab") as f2:
                                ...
                                if c==1:
                                    ...
                                    while block<lenf2:
                                        ...
                                        reamainer_2=block%3+block
                                        reamainer_3=block%4
                                        reamainder_4=block%25
                                        reaimender_5=block%12
                                        reaimender_6=block%27
                            ...
                            with open(nameas, "ab") as f2:
                                ...
                                if c==1:
                                    ...
                                    while block<lenf2:
                                        ...
                                        reamainer_2=block%2+(block//8)
                                        reamainer_3=block+(block//8)+(block//8)
                                        reamainder_4=block%4+(block//8)
                                        reaimender_5=block%5+(block//8)
                                        reaimender_6=block%6+(block//8)
                                        if remaider==0 and reamainer_2==0 or remaider==0 and reamainer_3==0 or remaider==0 and reamainer_3==0 or remaider==0 and reamainer_4==0 or remaider==0 and reamainer_5==0 or remaider==0 and reamainer_6==0:
